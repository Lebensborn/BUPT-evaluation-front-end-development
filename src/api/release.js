...
export function ReleaseItem(form) {
    ...
    if(form.range == "计算机学院19级"){
        range = ['2019211301', '2019211302', '2019211303', '2019211304', '2019211305', '2019211306', '2019211307', '2019211308', '2019211309']
    }
    else if(form.range == '一大班'){
        range = ["2019211301", "2019211302", "2019211303"]
    }
    else if(form.range == '二大班'){
        range = ["2019211304", "2019211305", "2019211306"]
    }
    else if(form.range == '三大班'){
        range = ["2019211307", "2019211308", "2019211309"]
    }
    else{
        range = [form.range];
    }
